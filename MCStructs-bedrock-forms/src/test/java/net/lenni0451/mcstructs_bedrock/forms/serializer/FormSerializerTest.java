...
class FormSerializerTest {
    ...
    private static final String ACTION_FORM_JSON = "{\"buttons\":[{\"text\":\"Button without image\"},{\"image\":{\"data\":\"textures/items/diamond_shovel\",\"type\":\"path\"},\"text\":\"Button with image\"}],\"content\":\"Action Form Test\",\"title\":\"Action Form Title\",\"type\":\"form\"}";
